...
public static class AWebUtils
{
	...
	public static string OnWebRequestGet(string url, string body)
	{
		if (!string.IsNullOrEmpty(body))
		{
			url = url + "?" + body;
		}
		return OnWebRequestGet(url);
	}
	...
	public static string OnWebRequestPost(string url, string body, string ContentType = "application/x-www-form-urlencoded")
	{
