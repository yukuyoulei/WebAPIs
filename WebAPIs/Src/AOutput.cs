...
public class AOutput : Singleton<AOutput>
{
	...
	{
		AOutput.Instance.log(slog, ELogLevel.Error);
	}
	public static void Log(string slog, ELogLevel elog = ELogLevel.Info, bool bIgnoreDel = false)
	{
		AOutput.Instance.log(slog, elog, bIgnoreDel);
	}
	public bool bDelWithTime = false;
	public static bool bShowOutput = true;
	public void log(string slog, ELogLevel elog = ELogLevel.Info, bool bIgnoreDel = false)
	{
		if (!bShowOutput)
		{
			return;
